...
import { DividendCalculator, formatPercentage } from '@/utils/dividendCalculator';
...
export default function StockGrid({ calculator, allocations }: StockGridProps) {
  ...
  const getAllocationForStock = (symbol: string) => {
    return allocations.find(alloc => alloc.symbol === symbol)?.percentage || 0;
  };
              ...
              <div className="p-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-slate-400">Annual Growth</span>
                    <div className="flex items-center space-x-1">
                      ...
                      <span className={cn(
                        "text-xs font-medium",
                        stock.annualGrowthRate >= 0 ? "text-green-400" : "text-red-400"
                      )}>
