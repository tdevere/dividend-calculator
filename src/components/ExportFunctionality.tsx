...
import { Database, Download, FileJson, FileSpreadsheet, FileText, Loader2 } from 'lucide-react';
import React, { useState } from 'react';

// Define proper types for portfolio and calculation data
                            ...
                            {exportOptions.map((option) => {
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className={`w-full p-3 rounded-lg border transition-all duration-200 text-left ${option.disabled
